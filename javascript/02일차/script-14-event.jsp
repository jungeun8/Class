...
<body>
	<h1>이벤트 연습</h1>
	<div id="text-box">
		<div id="text-box-1">첫 번째 글 박스입니다.</div>
		<div id="text-box-2">두 번째 글 박스입니다.</div>
		<div id="text-box-3">세 번째 글 박스입니다.</div>
	</div>
	<div id="btn-box">
	<!-- 
		사용자가 버튼을 클릭했을 때 사용자와 상호작용하기 위해서 onclick 이벤트를 사용함 
		해당 엘리먼트에서 onclick 이벤트가 발생하면 실행될 이벤트헨들러 함수를 바인딩시킨다.
	 -->
	...
	<script type="text/javascript">
		...
		function firstEventHandler(){
			...
			// 1. html document객체에서 아이디가 text-box-1인 엘리먼트를 찾기 
		...
		function secondEventHandler(){
			...
			// 1. html Decument객체에서 아이디가 "text-box-2"인 엘리먼트를 찾기 
