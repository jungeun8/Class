...
<div class="container">
	...
	<form action="">
		...
		기술: <input type="checkbox" name="skil" value="java" checked/>자바
		 	 <input type="checkbox" name="skil" value="c"/>c
		 	 <input type="checkbox" name="skil" value="python"/>파이썬
		 	 <input type="checkbox" name="skil" value="db"/>데이터베이스<br />
