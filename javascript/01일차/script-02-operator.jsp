...
<script type="text/javascript">
	...
	// == 연산자와 === 연산자
	// == 연산자는 값의 타입이 다르더라도 변환후 값은 값이면 true로 판정한다.
	...
	// != 연산자와 !== 연산자 
	// != 연산자는 값이 다르면 ture로 판정한다. 
	// !== 연산자는 타입, 값 둘중 하나만 달라도 true를 반환한다. 
	...
	console.log("5 != '8'", 5 != '8');	//ture		타입도 다르고, 값도 달라서 ture
