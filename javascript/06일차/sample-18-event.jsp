...
<body>
<div class="container">
	<h1>이벤트발생시 실행되는 기본 행동이 실행되지 않게 하기</h1>
	
	<p>
		a태크는 onclick이벤트가 발생하면 지정된 링크로 이동하는 것이 기본행동이다.<br/>
		form태그는 onsubmit이벤트가 발생하면 서버로 폼입력값을 제출하는 것이 기본행동이다.<br/>
		
		a태그를 클릭해도 지정된 링크로 이동되지 않게 하기,
		submit이벤트가 발생해도 폼입력값을 제출하지 않게 하고 싶다.
	</p>
...
<script type="text/javascript">
	...
	$('#link-2').click(function(event){
		// jQuery의 이벤트 핸들러 함수가 최종적으로 false 값을 반환하면
		// 해당 이벤트 발생시 자동 실행되는 기본생동의 실행을 방해한다. 
		return false;
	});
