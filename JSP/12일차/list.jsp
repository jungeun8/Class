...
%>
	...
	<%
		...
		// SAMPLE_ITEMS와 SAMPLE_CART_ITES 테이블에 대한 CRUD 기능을 제공하는 객체 생성
		CartItemDao cartItemDao = CartItemDao.getInstance();
		// 로그인한 사용자의 장바구니 정보 조호하기
	...
	<div class="row mb-3">
		...
		<div class="row mb-3">
			<div class="alert alert-danger">
				<strong>아이템없음</strong> 유효한 아이템번호가 아닙니다.
			</div>
		</div>
		<%
		}
				...
				<form method="get" action="../order/insert.jsp">
					<div class="card-body pb-0">
						...
						<div class="mb-2">
							...
							<button type="submit" class="btn btn-outline-primary btn-sm">선택 주문</button>
						</div>
						</div>
					</form>
				</div>
