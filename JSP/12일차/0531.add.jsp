...
//sample_cart_items 테이블에 대한 crud기능이 구헌된 cartitemdao객체 획득하기
CartItemDao cartItemDao = CartItemDao.getInstance();

// CartItemDao객체의 insertCartItem(장바구니아이템정보)를 실행해서 장바구나 아이템정보를 저장한다.
