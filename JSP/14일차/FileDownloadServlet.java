...
public class FileDownloadServlet extends HttpServlet{
	...
	private static final String saveDirectory="/Users/jungeun-kim/workspace/java-web/upload";
	...
	// 획득된 파일 이름에 해당하는 파일을 읽어서 클라이언트에게 응답으로 출력하기 
...
// 다운로드되는 파일의 이름을 응답메시지의 헤더에 설정한다. 
