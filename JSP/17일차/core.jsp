...
<div class="container">
	...
	<div class="row mb-3">
		<div class="col-12">
		<h3>set태그와 remove태그를 사용해보기</h3>
		
		<h4>set태그를 이용해서 최고점수롸 최저점수를 출력하기</h4>
		...
		<c:set target="${king }" property="kor" value="90"></c:set>
	...
	<div class="row mb-3">
		<div class="col-6">
			...
			<c:url var="bookDetailLink" value="bokk/detail">
			...
			<p>링크: <a href="${bookDeatailLink }">상세보기</a> </p>
